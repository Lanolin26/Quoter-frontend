  ...
  <div style="margin: 1%;">
    ...
    >
      <template v-slot:top-left>
        <q-toolbar flat>
          <q-toolbar-title>{{ $t('menu.manage.source') }}</q-toolbar-title>
      ...
      <template v-slot:body-cell-type="props">
        <q-td :props="props">
          <q-chip outlined size="sm" :label="props.value.type"/>
        </q-td>
      </template>
    </q-table>
  </div>
...
export default defineComponent({
  ...
  props: {
    ...
    sources: {default: <Array<QuoteSource>>[], type: Object as PropType<Array<QuoteSource>>, required: true},
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {name: 'type', label: 'quote.fields.sourceType', align: 'left', sortable: false, field: 'type'},
        {name: 'sourceName', label: 'quote.fields.source', align: 'left', sortable: false, field: 'sourceName'},
